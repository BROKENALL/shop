...
<div class="am-container header">
    <ul class="message-l">
        <div class="topMessage">
            <div class="menu-hd">
                <a href="javascript:void(0)" target="_top" class="h">亲，请登录</a>
                <a href="javascript:void(0)" target="_top">免费注册</a>
            </div>
        </div>
    </ul>
    <ul class="message-r">
        ...
        <div class="topMessage favorite">
            <div class="menu-hd"><a href="javascript:void(0)" target="_top"><i
                ...
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="javascript:void(0)"><img src="${cd.photo}" mid="${cd.photo}"
                                                              big="${cd.photo}"></a>
                        </div>
                    </li>
                </ul>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${cd.price}</b></dd>
                    </li>
                ...
                <ul class="tm-ind-panel">
                    <li class="tm-ind-item tm-ind-sellCount canClick">
                        <div class="tm-indcon"><span class="tm-label">热度</span><span
                                class="tm-count">${cd.hot}</span></div>
                    </li>
                                    ...
                                    <div class="theme-options">
                                        ...
                                        <dd>
                                            ...
                                            <span id="Stock" class="tb-hidden">库存<span
                                                    class="stock">${cd.number}</span>件</span>
                                        </dd>
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <div class="am-tab-panel am-fade">
                            ...
                            <div class="tb-reviewsft">
                                <div class="tb-rate-alert type-attention">购买前请查看该商品的 <a
