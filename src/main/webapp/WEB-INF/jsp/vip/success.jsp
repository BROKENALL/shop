...
<div class="am-container header">
  ...
  <ul class="message-r">
    ...
    <div class="topMessage my-shangcheng"><div class="menu-hd MyShangcheng"><a href="frame/index" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div></div>
    <div class="topMessage mini-cart"><div class="menu-hd"><a id="mc-menu-hd" href="shopcart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div></div>
   ...
   <div class="successInfo">
     <ul>
       ...
       <div class="user-info">
         ...
         <p>收货地址： ${order.address.provinceName} ${order.address.cityName}  ${order.address.areaName}  ${order.address.streetName}</p>
       </div>
     ...
     <div class="option">
       <span class="info">您可以</span>
        ...
        <a href="person/orderinfo" class="J_MakePoint">查看<span>交易详情</span></a>
     </div>
    </div>
  </div>
</div>
